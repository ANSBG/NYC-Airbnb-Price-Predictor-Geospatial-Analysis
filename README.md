...
📂 Project Structure
├── data/
│   └── AB_NYC_2019.csv       # Dataset (Source: Kaggle)
├── outputs/
│   └── nyc_airbnb_map.html   # Interactive Heatmap generated by the code
├── notebook.ipynb            # The complete analysis, engineering, and modeling code
